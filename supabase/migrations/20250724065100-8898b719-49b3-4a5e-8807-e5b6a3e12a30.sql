...
-- Update some existing achievements to be more generic and build upon each other
UPDATE achievements_template 
SET 
  name = 'Erster Schritt',
  description = 'Löse deine ersten 5 Aufgaben in einem beliebigen Fach'
WHERE type = 'questions_solved' AND requirement_value = 1 AND category != 'general';
